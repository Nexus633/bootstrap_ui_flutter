...
| `variant` | `BsAlertVariant` | `.primary` | The color scheme of the alert. |
...
| `animation` | `BsAlertAnimation` | `.fade` | The type of animation when showing and hiding (fade, none, slideTop, slideBottom, slideLeft, slideRight). |
